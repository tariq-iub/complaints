...
@section('content')
    ...
    <div class="mb-5">
        <h2 class="text-bold text-body-emphasis">Handlers for {{ $section->title }}</h2>
        <p class="text-body-tertiary lead">
            Manage handlers for the section.
        </p>
    </div>
        ...
        <div class="row align-items-center justify-content-between g-3 mb-4">
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Search handlers"
                               aria-label="Search"/>
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    ...
                    <a class="btn btn-primary" href="{{ route('section-handlers.create', $section) }}">
        ...
        <div class="mx-n4 mx-lg-n6 px-4 px-lg-6 mb-9 bg-body-emphasis border-y mt-2 position-relative top-1">
            <div class="table-responsive scrollbar ms-n1 ps-1">
                <table class="table table-sm fs-9 mb-0">
                    <thead>
                    <tr>
                        <th class="sort align-middle" scope="col" style="width:30%; min-width:200px;">
                            SECTION ID
                        </th>
                        <th class="sort align-middle" scope="col" style="width:30%; min-width:200px;">
                            USER ID
                    ...
                    @foreach($handlers as $handler)
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="align-middle white-space-nowrap">{{ $handler->section_id }}</td>
                            <td class="align-middle white-space-nowrap">{{ $handler->user_id }}</td>
                            <td class="align-middle white-space-nowrap">{{ $handler->is_heard }}</td>
                            <td class="actions align-middle text-end white-space-nowrap text-body-tertiary">
                                <div class="btn-reveal-trigger position-static">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a class="dropdown-item" href="{{ route('section-handlers.edit', $handler) }}">
                                            Edit
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <form action="{{ route('section-handlers.destroy', $handler) }}" method="POST"
